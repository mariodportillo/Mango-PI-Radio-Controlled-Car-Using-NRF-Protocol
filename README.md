...
**Joystick Functionality**
	...
	Using our MCP connection we were then able to process and handle inputs of Joystick positioning which we learned from this resource: [Joystick Reference](https://lastminuteengineers.com/joystick-interfacing-arduino-processing/) was done on an x and y axis. Now that we understood what the values were we could process these values and begin building our scan codes to be transmitted to the other NRF device. 

**Motor** **Functionality**

**	**Given the H-bridge component of the motor driver, interfacing with the motor driver was not too challenging seeing that we could employ PWM and basic GPIO write functions to control the motor driver. In the motor.h file we built out basic functions such as driving each motor individually then driving for time given a millisecond input in 4 different directions such as forwarded, left, right, and backward.
...
[nRF24L01 datasheet here](https://www.mouser.com/datasheet/2/297/nRF24L01_Product_Specification_v2_0-9199.pdf)

[MCP3008 datasheet here](https://cdn-shop.adafruit.com/datasheets/MCP3008.pdf)

[L298N references](https://lastminuteengineers.com/l298n-dc-stepper-driver-arduino-tutorial/)

[SPI Reference ](https://www.youtube.com/watch?v=MCi7dCBhVpQ&ab_channel=BenEater)

[Joystick Reference](https://lastminuteengineers.com/joystick-interfacing-arduino-processing/)

Our MangoPi NRF library was inspired by [this](https://github.com/controllerstech/NRF24L01/blob/master/NRF24L01.c) amazing library by ControllersTech for an STM32 microcontroller.
...
[Demo_Day.HEIC](https://github.com/cs107e/win25-project-Sahan-Samarakoon-mariodportillo/blob/master/Demo_Day.HEIC)

[Final_Robot.HEIC](https://github.com/cs107e/win25-project-Sahan-Samarakoon-mariodportillo/blob/master/Final_Robot.HEIC)

[simple-motor.jpeg](https://github.com/cs107e/win25-project-Sahan-Samarakoon-mariodportillo/blob/master/simple-motor.jpeg)
